...
from franca.eval.metrics import AccuracyAveraging, build_topk_accuracy_metric
...
from franca.eval.utils import ModelWithNormalize, evaluate, extract_features
...
def eval_knn(
    ...
    train_features, train_labels = extract_features(model, train_dataset, batch_size, num_workers, gather_on_cpu=gather_on_cpu)
